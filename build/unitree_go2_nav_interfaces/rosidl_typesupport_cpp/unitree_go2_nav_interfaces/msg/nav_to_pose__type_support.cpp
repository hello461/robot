...
static const _NavToPose_type_support_symbol_names_t _NavToPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unitree_go2_nav_interfaces, msg, NavToPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_go2_nav_interfaces, msg, NavToPose)),
  }
};
...
{
  return &::unitree_go2_nav_interfaces::msg::rosidl_typesupport_cpp::NavToPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unitree_go2_nav_interfaces, msg, NavToPose)() {
  return get_message_type_support_handle<unitree_go2_nav_interfaces::msg::NavToPose>();
}
